...
Design turns evidence into human-readable QA artifacts. It stays framework-neutral even when an
...
Feature files are the shared artifact for manual testers, Xray import, and automation adapters.
Adapters may materialize derived copies later.
...
- what automation adapter, if any, can run later.
