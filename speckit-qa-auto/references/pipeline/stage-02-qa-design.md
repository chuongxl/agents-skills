...
3. **Draft Design & Scenarios:** Author `test-design.md` and framework-neutral source `.feature` files under `specs/qa/<issue>/`.
   - *On-Demand Modules*: If scenarios involve accessibility, visual comparison, or API payload verification, load `references/modules/a11y-testing.md`, `references/modules/visual-regression.md`, or `references/modules/api-contract-testing.md` as needed.
